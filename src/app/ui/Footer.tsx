...
export const Footer = () => {
  return (
    <footer className='container mx-auto p-5'>
      <div className='grid grid-cols-3 items-center gap-4 md:gap-10 py-10'>
        ...
        <div className='col-span-3 md:col-span-1 flex md:justify-center'>
          <Image
            src={icongrab}
            className='h-10 w-24 md:h-20 md:w-48'
            alt={'grab'}
            title={'icongrab'}
            width='0'
            height='0'
        ...
        <p className='col-span-3 md:col-span-1 text-gray-500'>
